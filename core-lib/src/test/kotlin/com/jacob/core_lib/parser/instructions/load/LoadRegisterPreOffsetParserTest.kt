...
internal class LoadRegisterPreOffsetParserTest {
    ...
    internal fun `creates correct load instruction with single digit positive offset`() {
        ...
        val instruction = LoadRegisterPreOffsetParser(line).parse()

        instruction `should be instance of` Always::class
        instruction as Always

        instruction.instruction.apply {
            this `should be instance of` LoadRegisterAddressWithPreOffset::class
            this as LoadRegisterAddressWithPreOffset
