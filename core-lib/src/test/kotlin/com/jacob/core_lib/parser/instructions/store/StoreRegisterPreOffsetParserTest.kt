...
internal class StoreRegisterPreOffsetParserTest {
    ...
    internal fun `creates correct store instruction with single digit positive offset`() {
        ...
        val loadInstruction = StoreRegisterPreOffsetParser(line).parse()

        loadInstruction `should be instance of` StoreRegisterAddressWithPreOffset::class

        loadInstruction as StoreRegisterAddressWithPreOffset
